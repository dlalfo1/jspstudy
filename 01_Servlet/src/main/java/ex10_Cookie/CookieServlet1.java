...
public class CookieServlet1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
			...
			1. 서버가 만들어서 클라이언트가 저장한다. (response로 처리한다.)
			   =>백에서 만들기 번거로워서 제이쿼리 쿠키를 사용한다.
			2. 보안에 취약하다. (중요한 정보는 쿠키에 보관하지 않는다.)
	 */
		
		// 쿠키 만들기
		Cookie cookie1 = new Cookie("name", "이미래");
		...
		cookie2.setMaxAge(60 * 60);      	 // 1시간동안 보관되는 쿠키
											 ...
											 // 쿠키를 삭제하려면 유효시간을 0으로 주면 된다. (저장과 삭제의 코드가 똑같다.)
		
		// 쿠키 저장하기(응답으로 처리해야 한다.) => 브라우저에 저장된다.
